<template>
  <div>
      ...
      <el-col :span="4">
        <div class="ability-item">
          ...
          <p class="ability-content">
            熟练使用Python开发Web程序,脚本程序,tkinter图形用户界面程序
          </p>
        </div>
      </el-col>
    ...
    <el-row type="flex" justify="center">
      <el-col :span="14">
        <h3 class="jobTitle">工作经历</h3>
        <div class="block">
          <el-timeline class="job">
            <el-timeline-item
              v-bind:timestamp="this.company.xiaomi.range"
              placement="top"
            >
              <el-card>
                <div class="clearfix">
            ...
            <el-timeline-item
              v-bind:timestamp="this.company.cm.range"
              placement="top"
            >
              <el-card>
                <div class="clearfix">
            ...
            <el-timeline-item
              v-bind:timestamp="this.company.thunder.range"
              placement="top"
            >
              <el-card>
                <div class="clearfix">
            ...
            <el-timeline-item
              v-bind:timestamp="this.company.wh.range"
              placement="top"
            >
              <el-card>
                <div class="clearfix">
            ...
            <el-timeline-item
              v-bind:timestamp="this.company.wk.range"
              placement="top"
            >
              <el-card>
                <div class="clearfix">
